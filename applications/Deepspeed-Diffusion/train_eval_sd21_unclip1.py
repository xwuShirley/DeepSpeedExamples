...
def main(cfg: TrainingConfig):
    ...
    if cfg.resume_from_checkpoint:
        ...
        path = None #'/vc_data/users/xwu/Model3d/render-data/mvdiffusion/wonder3dplus-SD21-unclip/wonder3dplus-SD21-unclip/outputs-512/mvdiffusion-unclip-8views0120real/checkpoint'
        if path is None:
            accelerator.print(
    ...
    for epoch in range(1):
        unet.eval()
        train_loss = 0.0
        global_step = cfg.pretrained_unet_path.split('/')[-1]
        for i in range(1):
        #for step, batch in enumerate(train_dataloader):
            ...
            #     text_inputs = tokenizer(text_prompt, padding="max_length", max_length=tokenizer.model_max_length, truncation=True, return_tensors="pt").to(accelerator.device)
            ...
            #     else:
            #         attention_mask = None
            #     prompt_embeds = text_encoder(text_input_ids.to(accelerator.device), attention_mask=attention_mask,)
