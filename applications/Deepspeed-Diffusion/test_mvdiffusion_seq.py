...
def main(
    ...
    image_encoder = CLIPVisionModelWithProjection.from_pretrained("stabilityai/stable-diffusion-2-1-unclip", subfolder="image_encoder", revision=cfg.revision)
    feature_extractor = CLIPImageProcessor.from_pretrained("stabilityai/stable-diffusion-2-1-unclip", subfolder="feature_extractor", revision=cfg.revision)
...
if __name__ == '__main__':
    ...
    elif cfg.num_views == 12:
        VIEWS = ["front", "back", "right", "left", "front_right", "front_left", "back_right", "back_left", "front_right_top", "front_left_top", "back_right_top", "back_left_top", ]
