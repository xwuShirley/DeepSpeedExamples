...
def main(cfg: TrainingConfig, args):
    ...
    unet = unet.to(get_accelerator().current_device_name(), dtype=torch.float16)
    ...
    if cfg.resume_from_checkpoint:
        ...
        # path = '/vc_data/users/xwu/Model3d/render-data/mvdiffusion/wonder3dplus-SD21-unclip/wonder3dplus-SD21-unclip/outputs-384/unclip-8views0207real-emberlrx1-5e-5/checkpoint' #'/vc_data/users/xwu/Model3d/render-data/mvdiffusion/wonder3dplus-SD21-unclip/wonder3dplus-SD21-unclip/outputs-512/mvdiffusion-unclip-8views0122real-emberlrx1-1e-4/checkpoint'
        path = None
        if path is None:
            print(
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if rank == 0:
                print(f"rank: {rank}, global_step: {global_step}, train_loss: {train_loss}, step_loss: {loss.detach().item()}, lr: {lr_scheduler.get_last_lr()[0]}")
            ...
            # torch.cuda.memory._dump_snapshot('mems/unclip-mem-zero2.pickle')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='configs/train/ortho/mvdiffusion-mix-unclip-ortho-4views-lvis-res768.yaml')
